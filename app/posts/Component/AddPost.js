      ...
      <div className="list-media">
        {mediaFiles.map((file, index) => (
          <div key={index} className="media-item">
            ...
            <EditableSpan placeholder="Give your media a description..." fontSize="normal" fontWeight="normal" onChangeText={(newDescription) => {handleDescriptionChange(index, newDescription)}} isEditable={true}/>
          </div>
        ))}
      </div>
